const myBro = [{
    firstName: 'Bamby',
    lastName: 'Plave',
    akaFriend: 'Idols2D*CUTE',
    age: 20
}, {
    firstName: 'Eunho',
    lastName: 'Plave',
    akaFriend: 'Idols2D*WEREWOLF',
    age: 23
}, {
    firstName: 'Noah',
    lastName: 'Plave',
    akaFriend: 'Idols2D*PRINCE',
    age: 22
}, {
    firstName: 'Yejun',
    lastName: 'Plave',
    akaFriend: 'Idols2D*BCAT',
    age: 20
}, {
    firstName: 'Hamin',
    lastName: 'Plave0',
    akaFriend: 'Idols2D*BABY',
    age: 22
}]

//console.log(myBro[1].firstName)

const myFriendsAKA = myBro.map(function (element, index) {
    return ({
        chi: element.firstName,
        chaya: element.akaFriend
    })
})

const myFriendsMoreThan = myBro.filter(function (element, index) {
    return element.age > 20 && element.lastName === 'Plave0'
})
...
const covidDeathOnlyProvince = covid0.map(function (element, index) {
    return ({
